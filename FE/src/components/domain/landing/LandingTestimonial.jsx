const LandingTestimonial = () => {
  return (
    <section className="testimonial reveal" id="testimonial">
      {/* Mobile decorative quote mark */}
      ...
      <div className="t-author">
        <div className="t-avatar" aria-hidden="true">RS</div>
        <div className="t-author-info">
          <div className="t-name">Rina Sari</div>
          <div className="t-role">Caregiver · Jakarta</div>
        </div>
      </div>
    </section>
  );
