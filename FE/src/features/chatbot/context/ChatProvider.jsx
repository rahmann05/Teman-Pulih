...
import { ChatContext } from '@/features/chatbot/context/ChatContext';
import { streamMessage, getChatHistory, clearChatHistory } from '@/features/chatbot/services/chatbotService';
...
export const ChatProvider = ({ children }) => {
  ...
  const send = useCallback(async (text) => {
    ...
    try {
      ...
      const timeoutId = setTimeout(() => controller.abort(), 30000); // 30s initial timeout

      const response = await streamMessage(text, controller.signal);
