...
const MODE_META = {
    ...
    MANDATORY_CHECKIN:      { icon: LuCircleCheck,     label: 'Check-in Dosis Wajib',       desc: 'Setiap notifikasi jadwal memerlukan konfirmasi — tidak bisa dilewati.' },
    PREVENTIVE_ALERT:       { icon: LuTriangleAlert,   label: 'Peringatan Pencegahan',      desc: 'Notifikasi ekstra dikirim jika dosis terlambat lebih dari 1 jam.' },
